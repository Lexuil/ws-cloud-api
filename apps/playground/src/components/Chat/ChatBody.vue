...
<template>
  <div
    class="w-full h-[42.7rem] chat-background bg-repeat bg-size-[24rem] px-10 py-2 overflow-auto relative"
  ...
  >
    <ol>
      ...
      >
        ...
        <DeleteMessageButton :message-id="message.id" />
      </li>
    </ol>
  </div>
</template>
