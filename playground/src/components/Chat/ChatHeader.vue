...
<template>
  <div class="flex items-center gap-3 bg-[#f0f2f5] p-3 rounded-t-lg w-full sm:w-96">
    <span class="block w-10 h-10 rounded-full bg-slate-300">
      <svg
        viewBox="0 0 212 212"
        height="212"
        width="212"
